...
Crafty.c("TiledMapBuilder", {
  ...
  createSprite:function( tileset ){
    return Crafty.sprite(tileset.tilewidth, tileset.tileheight, tileset.image, this.arrangeTiles( tileset ), tileset.spacing, tileset.spacing, tileset.margin /* boolean */);
  },
        ...
        for(var idx = 0; idx < mockEntities[layer].length; idx++ ){
          ...
          if( mockEntity == 0 ){
            ...
            if (mockEntity.ellipse) {
              ...
              entity.visible = true;
              console.log("Tile entity:", entity);
